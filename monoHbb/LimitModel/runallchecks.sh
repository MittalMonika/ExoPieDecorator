...
#datacard=datacards_monoHbb_2017/monoHbb_datacard_2017_2hdma_B_allregion_ggF_sp_0p35_tb_1p0_mXd_10_mA_800_ma_150.txt
#catg=B

#datacard=datacards_monoHbb_2017/monoHbb_datacard_2017_2hdma_R_allregion_ggF_sp_0p35_tb_1p0_mXd_10_mA_800_ma_150.txt
#catg=R
...
## CR only fit pulls 
#combine -M FitDiagnostics -d $datacardws -n _${catg}_${year}_${mode}_${dirname}  --saveShapes --saveWithUncertainties --setParameters mask_sr=1,mask_cat_B_sr=1,mask_cat_R_sr=1,mask_cat_F_sr=1 --X-rtd MINIMIZER_analytic --cminFallbackAlgo Minuit2,0:1.0
