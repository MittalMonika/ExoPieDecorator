...
def getEndPart_RP(reg):
    ...
    if reg=='SR':
        end_='''
ratett_e'''+category+''' rateParam SR tt 1. [0.5,1.5]        
ratett_mu'''+category+''' rateParam SR tt 1. [0.5,1.5]        
ratezjets_e'''+category+''' rateParam SR zjets 1. [0.5,1.5]
ratezjets_mu'''+category+''' rateParam SR zjets 1. [0.5,1.5]
'''
    if reg =='TOPE':
        end_='''  
ratett_e'''+category+''' rateParam TOPE tt 1. [0.5,1.5]
'''
    if reg =='TOPMU':
        end_='''  
ratett_mu'''+category+'''  rateParam TOPMU tt 1. [0.5,1.5]
'''
    if reg =='ZMUMU':
        end_='''    
ratezjets_mu'''+category+'''  rateParam ZMUMU dyjets 1. [0.5,1.5]        
'''
    if reg =='ZEE':
        end_=''' 
ratezjets_e'''+category+'''  rateParam ZEE dyjets 1. [0.5,1.5]        
'''       
    if end_ =='' :
