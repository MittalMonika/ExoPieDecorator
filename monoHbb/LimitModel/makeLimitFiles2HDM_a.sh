...
mAScan150=bin/scan_2d/limits_monoHbb_2hdmaScan_ma_150_tanbeta_1p0_sinth_0p35.txt
cat ${inputScan} | gawk 'NF>5 && $1==150 && $3==1 {print $1" "$2" "$6" "$7" "$8" "$9" "$10" "$11}'  > ${mAScan150}
sort  -k 2n ${mAScan150} -o ${mAScan150} -u 

## get ma=250, tanbeta = 1,
mAScan250=bin/scan_2d/limits_monoHbb_2hdmaScan_ma_250_tanbeta_1p0_sinth_0p35.txt
cat ${inputScan} | gawk 'NF>5 && $1==250 && $3==1 {print $1" "$2" "$6" "$7" "$8" "$9" "$10" "$11}'  > ${mAScan250}
sort  -k 2n ${mAScan250} -o ${mAScan250} -u 


## get ma=350, tanbeta = 1,
mAScan350=bin/scan_2d/limits_monoHbb_2hdmaScan_ma_350_tanbeta_1p0_sinth_0p35.txt
...
mAvsmaScan=bin/scan_2d/limits_monoHbb_2hdmaScan_ma_vs_mA_tanbeta_1p0_sinth_0p35.txt
...
tanbetaScan150=bin/scan_2d/limits_monoHbb_2hdmaScan_tanbetaScan_ma_150_mA_600_sinth_0p35.txt
...
tanbetaScan250=bin/scan_2d/limits_monoHbb_2hdmaScan_tanbetaScan_ma_250_mA_600_sinth_0p35.txt
...
sinthetaScan200=bin/scan_2d/limits_monoHbb_2hdmaScan_sinthetaScan_ma_200_mA_600_tanbeta_1.txt
