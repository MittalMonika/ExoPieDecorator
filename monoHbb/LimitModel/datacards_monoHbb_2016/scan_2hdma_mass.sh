...
samples_2hdma=(2HDMa-gg-sinp-0p35-tanb-1-mXd-10-MH3-600-MH4-200-MH2-600-MHC-600)
...
for k in "${samples_2hdma[@]}"; do
    ...
    #Computing limits                                                                                                                                                                 
    combine -M AsymptoticLimits combined.txt  --rAbsAcc 0 --rMax 30  | tee limits_tmp.txt
    ...
    echo "${sinp} ${tanb} ${mass_dm} ${mass_h3} ${mass_h4} ${mass_h3} ${mass_h3} ${twosigdown} ${onesigdown} ${exp} ${onesigup} ${twosigup} ${observed}" >> limits_2hdma_mass.txt        
done
