...
for i in range(len(regionlist)):
    ...
    makeStackMerged = myStack(fname_ = "fitDiagnostics_merged_2017_data.root", region_ = regionlist[i], isSR = isSR, prefitbackgroundlist_ = prefitbkglist, legendname_ = legendlist, colorlist_ = color, regionName_ = regionName[i], dirName_='plots_limit/Stack/', isMerged = True, pad1ymax_ = 100)

    makeStackResolved = myStack(fname_ = "fitDiagnostics_resolved_2017_data.root", region_ = regionlist[i], isSR = isSR, prefitbackgroundlist_ = prefitbkglist, legendname_ = legendlist, colorlist_ = color, regionName_ = regionName[i], dirName_='plots_limit/Stack/', isMerged = False, pad1ymax_ = 1000)
