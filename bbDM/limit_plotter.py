...
rt.gROOT.SetBatch(1)
if not os.path.exists('limit_plotFiles'): os.makedirs('limit_plotFiles')
...
for inputstring in inputstring_:
    ...
    rootfilename = 'limit_rootFiles/limit_bbDM2016_'+inputstring+'.root'
    ...
    name = "limit_plotFiles/limit_"+inputstring
    c.SetLogx(1)
    c.Update()
    #c.SaveAs(name+".png")
    c.SaveAs(name+".pdf")
